  ...
  return (
    <div id='info'>
        ...
        <Container  className='info bg-light'>
            <Row>
                <Col className='info1 d-flex justify-content-start align-items-center px-3 py-1'>
                    <div >
                        <i className="fa-solid fa-cube info-icon"></i>
                    </div>
                    <div className='ms-4'>
                        <p className='info-title'>Last Block</p>
                        <p className='fs-5'>16914281</p>
                    </div>
                    
                </Col>
                <Col className='info2 d-flex justify-content-start align-items-center px-3 py-1'>
                    <div >
            ...
            <Row>
                <Col className='info3 d-flex justify-content-start align-items-center px-3 py-1'>
                    <div >
                ...
                <Col className='info4 d-flex justify-content-start align-items-center px-3 py-1'>
                    <div >
                        <i className="fa-solid fa-comments-dollar info-icon"></i>
                    </div>
                    <div className='ms-4  '>
                        <p className='info-title'>Last Base Fee</p>
                        <p className='fs-5'>110 wei</p>
                    </div>
